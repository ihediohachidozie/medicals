                ...
                <div class="col-lg-6">
                  <div class="p-5">
                    <div class="text-center">
                      <h1 class="h4 text-gray-900 text-uppercase">Patient Login</h1>
                      <hr>
                    </div>
                    <form class="user form-prevent-multiple-submits" method="POST" action="{{ route('patient.login.submit') }}">
                      @csrf
                      @if (session('status'))
                    ...
                    <div class="">
                      ...
                      <a class="small float-right" href="{{route('patient.register')}}">Create an Account!</a>
                    </div>
                    <div class="text-center">
