                ...
                <div class="col-lg-6">
                  <div class="p-4">
                    <div class="text-center">
                      <h1 class="h4 text-gray-900 text-uppercase">Hospital Login</h1>
                      <hr>
                    </div>
                    <form class="user form-prevent-multiple-submits" method="POST" action="{{ route('hospital.login.submit') }}">
                      @csrf
                      @if (session('status'))
                    ...
                    <div class="">
                      ...
                      <a class="small float-right" href="{{route('hospital.register')}}">Create an Account!</a>
                    </div>
                    <div class="text-center">
